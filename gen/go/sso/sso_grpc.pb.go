...
const (
	...
	AuthService_RefreshTokens_FullMethodName = "/sso.AuthService/RefreshTokens"
...
type AuthServiceClient interface {
	...
	RefreshTokens(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*TokenRefreshResponse, error)
	// *
	// Завершение сессии
	// Инвалидирует оба токена (добавляет в revocation list)
	Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*model.OperationStatus, error)
}
...
func (c *authServiceClient) RefreshTokens(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*TokenRefreshResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authServiceClient) Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*model.OperationStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(model.OperationStatus)
...
type AuthServiceServer interface {
	...
	// Требует: валидный refresh_token
	// Возвращает: новую пару токенов
	RefreshTokens(context.Context, *RefreshTokenRequest) (*TokenRefreshResponse, error)
	// *
	// Завершение сессии
	// Инвалидирует оба токена (добавляет в revocation list)
	Logout(context.Context, *LogoutRequest) (*model.OperationStatus, error)
...
func (UnimplementedAuthServiceServer) RefreshTokens(context.Context, *RefreshTokenRequest) (*TokenRefreshResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RefreshTokens not implemented")
}
func (UnimplementedAuthServiceServer) Logout(context.Context, *LogoutRequest) (*model.OperationStatus, error) {
